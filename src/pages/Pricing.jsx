...
const Pricing = ({ onEarlyAccessClick }) => {
 ...
 return (
  <>
   <header className={styles.head}>
    ...
    <p>
     Give your team the tools to move faster, work smarter, and deliver more
    </p>
   </header>
    ...
    <section className={styles.main1}>
      ...
      <div className={styles.pricing__cards}>
       ...
       <section className={styles.pricing__cards__features}>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Single User — Can be added to only 1 team at a time, and cannot add
          people to teams. Cannot create teams to co-manage multiple files and
          folders
         </span>
        </p>
        <p>
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Limited Notes & Docs — Create and edit up to your storage limit
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          No AI Features — Access our core tools, without AI enhancements
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          10MB Cloud Storage — Store, collaborate and manage your files with
          ease
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>Scan Documents — Digitize your paperwork effortlessly</span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Invite Signers — Request signatures from up to 1 person per document,
          on 3 documents/month
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Create Forms — Design forms and collect responses and payments easily;
          1% fee on payments received
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Publish & Earn — Share your Notes and earn from your premium content,
          subject to 30% platform fee
         </span>
        </p>
       </section>
      </div>
      ...
      <div className={styles.pricing__cards}>
       ...
       <section className={styles.pricing__cards__features}>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Team Access — Create up to 2 teams and be added to unlimited teams to
          co-manage multiple files and folders
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Unlimited Notes & Documents — Create and edit with a higher storage
          limit
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Limited AI Access — Up to 300,000 tokens/month using Gemini 2.5 only
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>1GB Cloud Storage — More room for your growing work</span>
        </p>
        <p>
         <img src={SVG23} alt='' />
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Unlimited Self-Signing — Sign all your documents with no limits
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Invite Signers — Request up to 5 signers per document, on up to 20
          docs/month
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Create Smart Forms — Collect responses, accept payments, and access
          AI-powered insights (limited by AI credits); 0.5% fee on payments
          received
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Publish & Earn — Monetize your Notes; 20% platform fee on premium
          content
         </span>
        </p>
       </section>
      ...
      <div className={styles.pricing__cards}>
       ...
       <section className={styles.pricing__cards__features}>
        <p>
         <img src={SVG24} alt='' />
         <span>
          Team Access — Create up to 10 teams and be added to unlimited teams to
          co-manage multiple files and folders
         </span>
        </p>
        <p>
        ...
        <p>
         <img src={SVG24} alt='' />
         <span>
          Unlimited Notes & Documents — Create, edit, and organize with more
          storage
         </span>
        </p>
        <p>
        ...
        <p>
         <img src={SVG24} alt='' />
         <span>
          High AI Access — Enjoy up to 1 million tokens/month and access to
          multiple AI models for smarter workflows
         </span>
        </p>
        <p>
         <img src={SVG24} alt='' />
         <span>
          10GB Cloud Storage — Store, manage, and collaborate with ease
         </span>
        </p>
        <p>
         <img src={SVG24} alt='' />
        ...
        <p>
         <img src={SVG24} alt='' />
         <span>
          Invite Signers — Request signatures from up to 15 people per document,
          on 500 documents/month
         </span>
        </p>
        <p>
         <img src={SVG24} alt='' />
         <span>
          Create & Model Forms — Collect responses, accept payments, and unlock
          advanced AI insights; 0.5% fee on payments received
         </span>
        </p>
        <p>
         <img src={SVG24} alt='' />
         <span>
          Publish & Earn More — Monetize premium Notes with only a 10% platform
          fee
         </span>
        </p>
       </section>
      ...
      <div className={styles.pricing__cards}>
       ...
       <section className={styles.pricing__cards__features}>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Team Access — Create unlimited teams and be added to unlimited teams
          to co-manage multiple files and folders
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Unlimited Notes & Documents — Create and edit without limits, with
          more storage
         </span>
        </p>
        <p>
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          High AI Access — Get up to 3 million tokens/month and access to more
          AI models for advanced output
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          100GB Cloud Storage — Collaborate and manage a high volume of files
          with ease
         </span>
        </p>
        <p>
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Invite Signers — Request signatures from up to 30 people on up to
        ...
        <p>
         <img src={SVG23} alt='' />
         <span>
          Create & Model Forms — Collect responses, accept payments, and access
          deep AI insights; 0.3%% fee on payments received
         </span>
        </p>
        <p>
         <img src={SVG23} alt='' />
         <span>
          Publish & Earn — Monetize premium Notes with just a 5% platform fee
         </span>
        </p>
       </section>
      </div>
     ...
     <section className={styles.container}>
      ...
      <div className={styles.featuresTable}>
       ...
       <div className={styles.featureRow}>
        <div className={styles.featureName}>Intelligent Document Creation</div>
        <div className={styles.featureValue}>no</div>
       ...
       <div className={styles.featureRow}>
        <div className={styles.featureName}>Intelligent Document Review</div>
        <div className={styles.featureValue}>no</div>
        <div className={styles.featureValue}>limited</div>
        <div className={styles.featureValue}>yes</div>
        <div className={styles.featureValue}>yes</div>
